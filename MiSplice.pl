...
sub bsub_maf_split{
	...
	print NS "cut -f 1,5,6,7,8,9,10,11-13,16,17,115 *.maf > NS_CASE/misplice.input.maf.1\n";
	print NS "cp NS_CASE/misplice.input.maf.1 misplice.input.maf\n";
	print NS "fi\n";
	#
...
sub bsub_job_array_ns {
	...
	print ANS "ANS_OUT=".$run_dir."/NS_CASE/misplice.input.maf."."1".".v2.filtered.5\n";
	#print ANS "ANS_IN=".$run_dir."/NS_CASE/misplice.input.maf.".'${LSB_JOBINDEX}'."\n";
	print ANS "ANS_IN=".$run_dir."/NS_CASE/misplice.input.maf."."1"."\n";
...
sub bsub_control {
    ...
    print CONTR "FS=".$script_dir."/resource/Samples\n";	
...
#    print CONTRS "#BSUB -w \"$hold_job_file\"","\n";
	...
	foreach my $contr_files (1..$NUM_CONTR){
    		print CONTRS "CONT_OUT=".$run_dir."/Controls/novel.junctions.filtered.controls.".${contr_files}.".v2.filtered.5\n";
  		print CONTRS "CONT_IN=".$run_dir."/Controls/novel.junctions.filtered.controls.".${contr_files}."\n";    
    ...
    # perl misplice/in_silico_ns.control.v4.pl novel.junctions.filtered.controls novel.junctions.filtered.controls.v2.filtered.5 misplice/.
...
#    print EXPF "#BSUB -w \"$hold_job_file\"","\n";
   # print EXPF "#BSUB -q ding-lab\n";
	print EXPF "FS=".$script_dir."/resource/Samples\n";
...
sub bsub_job_array_rc {
    ...
    print RC "#!/bin/bash\n";
    print RC "DIR_OUT=".$run_dir."/RC\n";
    print RC "if [ ! -d \${DIR_OUT} ]\n";
    print RC "then\n";
    print RC "mkdir \${DIR_OUT}\n";
    print RC "fi\n";
#    print RC "#BSUB -n 1\n";
...
#    print RC "#BSUB -w \"$hold_job_file\"","\n";
    ...
    print RC "MAF=".$run_dir."/novel.splice.scores\n";
    #####################
    print RC "RC_OUT=".$run_dir."/RC/novel.splice.scores."."1".".rc\n";
    print RC "RC_IN=".$run_dir."/RC/novel.splice.scores."."1"."\n";
    print RC "cp \${MAF} \${RC_IN}\n";
...
#    print RCHLA "#BSUB -J $current_job_file\n";
   # print RCHLA "#BSUB -q ding-lab\n";
    print RCHLA "RCT=".$run_dir."/novel.splice.scores.1.rc\n";
